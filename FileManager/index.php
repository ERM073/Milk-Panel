            ...
            <?php if (!$quickView) { ?>
                ...
                <p>
                    ...
                    ?>
                        ...
                        <b><a href="?p=<?php echo urlencode(trim(FM_PATH)) ?>&amp;edit=<?php echo urlencode($file) ?>&env=ace" class="edit-file" target="_blank"><i class="fa fa-pencil-square-o"></i> <?php echo lng('AdvancedEditor') ?>
                            </a></b> &nbsp;
                    <?php } ?>
...
?>
    ...
    <head>
        ...
        <title><?php echo (isset($_GET['edit'])) ? $_GET['edit'] : 'Milk | Filemanager'; ?></title>
        <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
        ...
        ?>
            ...
            <script>
                ...
                editor.getSession().setMode({
                    path: "ace/mode/<?php echo ($ext == 'php') ? 'php_laravel_blade' : $ext; ?>",
                    inline: true
                });
